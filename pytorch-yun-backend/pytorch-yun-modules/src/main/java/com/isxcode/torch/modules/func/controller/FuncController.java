package com.isxcode.torch.modules.func.controller;

import com.isxcode.torch.api.func.pojos.req.UpdateFuncReq;
import com.isxcode.torch.api.func.pojos.res.PageFuncRes;
import com.isxcode.torch.api.main.constants.ModuleCode;
import com.isxcode.torch.api.func.pojos.req.AddFuncReq;
import com.isxcode.torch.api.func.pojos.req.DeleteFuncReq;
import com.isxcode.torch.api.func.pojos.req.PageFuncReq;
import com.isxcode.torch.common.annotations.successResponse.SuccessResponse;
import com.isxcode.torch.modules.func.service.FuncBizService;
