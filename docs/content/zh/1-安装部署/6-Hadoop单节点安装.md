...
```bash
mkdir -p /data/hadoop
chown -R zhihuiyun:zhihuiyun /data/hadoop 
```
...
export HDFS_NAMENODE_USER=zhihuiyun
export HDFS_DATANODE_USER=zhihuiyun
export HDFS_SECONDARYNAMENODE_USER=zhihuiyun
export YARN_RESOURCEMANAGER_USER=zhihuiyun
export YARN_NODEMANAGER_USER=zhihuiyun
export HDFS_ZKFC_USER=zhihuiyun
export HDFS_JOURNALNODE_USER=zhihuiyun
EOF
```
...
<configuration>
    ...
    <property>
        <name>hadoop.proxyuser.zhihuiyun.hosts</name>
        <value>*</value>
    </property>
  
    <property>
        <name>hadoop.proxyuser.zhihuiyun.groups</name>
        <value>*</value>
    </property>
